...
const startIndex = code.indexOf('function AICard({ run,');
const endIndex = code.indexOf('export default function WorkspacePage() {');

const newAICard = `function AICard({ run, status, content, activeRunId, referencedRunIds, retryRun, toggleRef, isMaximized, onToggleMaximize }: any) {
