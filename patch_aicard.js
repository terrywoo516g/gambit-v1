...
const startTag = 'function AICard({ run, status, content, activeRunId, referencedRunIds, retryRun, toggleRef }: any) {';
const endTag = 'export default function WorkspacePage() {';

const newAICard = `function AICard({ run, status, content, activeRunId, referencedRunIds, retryRun, toggleRef }: any) {
...
code = code.substring(0, startIndex) + newAICard + code.substring(endIndex);
